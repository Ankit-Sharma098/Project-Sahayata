      ...
      <div className="mx-auto flex min-h-[90vh] max-w-7xl items-center px-6">
        ...
        >
          ...
          <div className="mt-10 flex gap-5">
            ...
            <button className="flex items-center gap-2 rounded-xl bg-emerald-500 px-7 py-4 font-semibold text-white transition hover:bg-emerald-600">
            ...
            <button className="rounded-xl border border-slate-700 px-7 py-4 text-white transition hover:border-emerald-500">
